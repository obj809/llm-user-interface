  ...
  if (message.role === "user") {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] whitespace-pre-wrap rounded-2xl bg-zinc-100 px-4 py-2.5 text-base text-zinc-900 sm:max-w-[80%] sm:text-lg dark:bg-[#1f1f1f] dark:text-zinc-100">
          {message.content}
        </div>
      </div>
    );
